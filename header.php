...
<head>
    <meta charset="utf-8">
    <title>Bestmove Limited</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Real Estate, Construction,Painting, architecture" name="keywords">
            ...
            <div class="col-lg-4 text-center py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        ...
                        <span>P.O.box CT 2131 Cantoment-Accra</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center border-start border-end py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        ...
                        <span>bestmovegh@gmail.com</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center py-3">
        ...
        <nav class="navbar navbar-expand-lg bg-dark  navbar-dark py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="investment.php" class="nav-item nav-link">INVESTMENT</a>
